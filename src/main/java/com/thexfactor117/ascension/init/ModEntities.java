...
public class ModEntities 
{
	...
	public static Item bansheeEgg = new ItemAscensionMonsterPlacer("Banshee", 0x342D4A, 0xFCD80A).setUnlocalizedName("spawn_egg_" + "Banshee".toLowerCase());
	public static Item barbarianEgg = new ItemAscensionMonsterPlacer("Barbarian", 0xE32209, 0xE38F09).setUnlocalizedName("spawn_egg_" + "Barbarian".toLowerCase());
	public static Item ghostEgg = new ItemAscensionMonsterPlacer("Ghost", 0x807D79, 0xF22E18).setUnlocalizedName("spawn_egg_" + "Ghost".toLowerCase());
	public static Item goblinEgg = new ItemAscensionMonsterPlacer("Goblin", 0x342D4A, 0xFCD80A).setUnlocalizedName("spawn_egg_" + "Goblin".toLowerCase());
	public static Item golemEgg = new ItemAscensionMonsterPlacer("Golem", 0xF2961D, 0x45341E).setUnlocalizedName("spawn_egg_" + "Golem".toLowerCase());
	public static Item miniGolemEgg = new ItemAscensionMonsterPlacer("Mini-Golem", 0xF2961D, 0x45341E).setUnlocalizedName("spawn_egg_" + "Mini-Golem".toLowerCase());
	public static Item mummyEgg = new ItemAscensionMonsterPlacer("Mummy", 0x436E59, 0x7FAD94).setUnlocalizedName("spawn_egg_" + "Mummy".toLowerCase());
	public static Item snowBlazeEgg = new ItemAscensionMonsterPlacer("Snow Blaze", 0x9EF4FF, 0xE8FCFF).setUnlocalizedName("spawn_egg_" + "Snow Blaze".toLowerCase());
	public static Item trollEgg = new ItemAscensionMonsterPlacer("Troll", 0x9EF4FF, 0x9EF4FF).setUnlocalizedName("spawn_egg_" + "Troll".toLowerCase());
	public static Item valkyrieEgg = new ItemAscensionMonsterPlacer("Valkyrie", 0xFFFDE8, 0xF0E335).setUnlocalizedName("spawn_egg_" + "Valkyrie".toLowerCase());

	public static Item doeEgg = new ItemAscensionMonsterPlacer("Doe", 0x634F35, 0xF7F7F7).setUnlocalizedName("spawn_egg_" + "Doe".toLowerCase());
