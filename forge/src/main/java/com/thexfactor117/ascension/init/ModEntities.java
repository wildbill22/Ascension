...
public class ModEntities 
{
	...
	public static void addMobSpawns()
	{
		...
		EntityRegistry.addSpawn(EntityValkyrie.class, 100, 2, 6, EnumCreatureType.ambient, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.forestHills, BiomeGenBase.jungle, BiomeGenBase.jungleEdge, BiomeGenBase.jungleHills, BiomeGenBase.roofedForest);
